...
public class TextToSpeechWindow : Window
{
    ...
    public TextToSpeechWindow(TextToSpeechViewModel vm)
    {
        ...
        Title = UiUtil.MakeWindowTitle(vm.IsMultiSpeakerMode
            ? Se.Language.Video.TextToSpeech.TitleMultiSpeakers
    ...
    private Border MakeEngineControls(TextToSpeechViewModel vm)
    {
        ...
        panelActorVoices.Bind(Visual.IsVisibleProperty, new Binding(nameof(vm.IsActorVoicesPanelVisible)));
        if (Se.Settings.Appearance.ShowHints)
        {
